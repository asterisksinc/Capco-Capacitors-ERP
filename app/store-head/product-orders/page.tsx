...
export default function StoreHeadProductOrdersPage() {
                ...
                {paginatedProductOrders.map((row, idx) => (
                  <tr key={idx} className="hover:bg-gray-50/50 transition-colors group">
                    <td className="px-4 py-4 text-[14px] font-medium text-[#00B6E2] whitespace-nowrap">
                      <Link href={`/store-head/product-orders/${row.id.replace('#', '')}`} className="hover:underline cursor-pointer">
                        {row.id}
                      </Link>
                    </td>
                    ...
                    <td className="px-4 py-3 whitespace-nowrap">
                      <OptionsDropdown 
                        viewHref={`/store-head/product-orders/${row.id.replace('#', '')}`}
                        status={row.status}
                        onEdit={() => {}}
                        onDelete={() => {
